    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <p>
            Amo meu trabalho e gosto de cada novo projeto conforme o obtenho.
          ...
          <p>
            <strong>Obrigado</strong> por aparecer aqui!
          </p>
        </div>
        <div class="col-md-6">
          <div class="row">
...
<script>
import cProgressBar from '../utils/c-progress-bar.vue'
